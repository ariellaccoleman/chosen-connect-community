...
const EntityFeed = ({
  ...
  // Track currentPage prop changes with more specific logging
  useEffect(() => {
  ...
  }, [entities.length, activeTab, selectedTagId, search, isApproved, totalCount, currentPage, totalPages, hasNextPage]);
