...
// For production and regular app usage, always use the anon key
// Test infrastructure will use separate clients from testClient.ts
...
if (!isNodeEnvironment) {
  ...
  console.log("🔧 Supabase client initialized for Node.js environment with anon key");
}
